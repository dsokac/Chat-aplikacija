 ...
 */
public class SearchUsername implements IState {
    ...
    public SearchUsername(ArrayList<User> list, ListView lv, TextView search_text, Activity activity, ArrayList<User> reg_users)
    {
